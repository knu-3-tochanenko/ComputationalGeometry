package library; /******************************************************************************
 *  Compilation:  javac library.StdDraw.java
 *  Execution:    java library.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code library.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code library.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">library.StdDraw.java</a>
 ...
 *           library.StdDraw.setPenRadius(0.05);
 *           library.StdDraw.setPenColor(library.StdDraw.BLUE);
 *           library.StdDraw.point(0.5, 0.5);
 *           library.StdDraw.setPenColor(library.StdDraw.MAGENTA);
 *           library.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code library.StdDraw.line()} and {@code library.StdDraw.point()}
 *  draw lines and points; the methods {@code library.StdDraw.setPenRadius()}
 *  and {@code library.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code library.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   library.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code library.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code library.StdDraw.setPenColor(library.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code library.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code library.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   library.StdDraw.setFont(font);
 *   library.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code library.StdDraw.clear(library.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *       library.StdDraw.filledCircle(x, y, 0.05);
 *       library.StdDraw.filledCircle(-x, -y, 0.05);
 *       library.StdDraw.show();
 *       library.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code library.StdDraw.BLACK}, {@code library.StdDraw.BLUE}, {@code library.StdDraw.CYAN},
     * {@code library.StdDraw.DARK_GRAY}, {@code library.StdDraw.GRAY}, {@code library.StdDraw.GREEN},
     * {@code library.StdDraw.LIGHT_GRAY}, {@code library.StdDraw.MAGENTA}, {@code library.StdDraw.ORANGE},
     * {@code library.StdDraw.PINK}, {@code library.StdDraw.RED}, {@code library.StdDraw.WHITE}, and
     * {@code library.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to library.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to library.StdDraw)
        try {
            URL url = library.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
